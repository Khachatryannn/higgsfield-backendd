...
export const DB_CONFIG = Object.freeze({
  DATABASE_URL: process.env.DATABASE_URL || 'postgresql://postgres_db_higgsfield_user:GJQry8GR97OAe75jT46Hs0zqH0oeWWeL@dpg-d3rpt7ndiees73bub3v0-a/postgres_db_higgsfield',
